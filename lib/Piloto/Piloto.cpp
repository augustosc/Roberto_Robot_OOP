#include "Piloto.h" 
    ...
    void Piloto::scanAhead(){
        ...
        if(obstacle->isClose)  {
          if(Roberto.shouldTurnRight()){
            if (debug) Serial.println("SCAN AHEAD  | Right turn");
            Roberto.turnRight();
          }
          else {
            if (debug) Serial.println("SCAN AHEAD  | Left turn");
            Roberto.turnLeft();
          }
        }
    }
    ...
    void Piloto::scanFront(){
        ...
        if(obstacle->isClose)  {
          if(Roberto.shouldTurnRight()){
            if (debug) Serial.println("SCAN FRONT | Right Turn");
            Roberto.turnRight();
          }
          else {
            if (debug) Serial.println("SCAN FRONT | Left Turn");
            Roberto.turnLeft();
          }
        }
    }
